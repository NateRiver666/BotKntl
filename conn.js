...
fetchJson(`https://api.lolhuman.xyz/api/ouo?apikey=SadTeams&url=${q}`).then((res) => {
...
case 'mirrored':
if (!q) return reply('Contoh:\n#mirrorred (link)')
fetchJson(`https://api.lolhuman.xyz/api/mirrorcreator?apikey=SadTeams&url=${q}`).then((res) => {
	let hasil = ` Selamat link anda terbypass
...
case 'spotify':
if (!q) return reply('Contoh:\n#spotify linkdl')
fetchJson(`https://api.lolhuman.xyz/api/spotify?apikey=SadTeams&url=${q}`).then((res) => {
	let spo = `
...
case 'quoteanime':
fetchJson(`https://api.lolhuman.xyz/api/random/quotesnime?apikey=SadTeams`).then((res) => {
